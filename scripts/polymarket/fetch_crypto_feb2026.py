"""
Fetch BTC/USDT and ETH/USDT hourly OHLCV from Binance via CCXT for Feb 2026.

Focus: US/Israel-Iran strike event around 2026-02-28.

Outputs:
  data/polymarket/btc_1h_feb2026.csv
  data/polymarket/eth_1h_feb2026.csv

Usage:
  poetry run python scripts/polymarket/fetch_crypto_feb2026.py
"""
...
# Feb 20 – Mar 5 2026 (15 days; ~360 hourly candles)
...
SYMBOLS = [
    ("BTC/USD", "btc_1h_feb2026.csv"),
    ("ETH/USD", "eth_1h_feb2026.csv"),
]
